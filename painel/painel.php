        ...
        <main class="col h-100 text-light p-4">
            ...
            <nav aria-label="navigation">
                <ul class="pagination justify-content-end pt-4 pb-2">
                    <li class="page-item"><a class="page-link bg-custom border-dark link-light" href="#">Anterior</a>
                    </li>
                    ...
                    <li class="page-item"><a class="page-link bg-custom border-dark link-light" href="#">Próximo</a>
                    </li>
                </ul>
            </nav>
        </main>
