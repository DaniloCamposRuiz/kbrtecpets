...
<body>
    ...
    <section class="bg-light py-5">
        <div class="container mb-4 d-flex flex-column align-items-center">
            ...
            <div class="row">
                <div class="col-4">
                    <div class="d-flex align-items-center h-100 rounded overflow-hidden"
                        ...
                        <p class="m-0 p-3 h-100 d-flex align-items-center bg-white">
                            Nesse exato momento, existem milhares de doguinhos e gatinhos esperando um humano para
                            chamar de seu.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-4">
                    <div class="d-flex align-items-center h-100 rounded overflow-hidden"
                        ...
                        <p class="m-0 p-3 h-100 d-flex align-items-center bg-white">
                            E não há recompensa maior do que vê-los se tornando aquela coisinha alegre e saudável depois
                ...
                <div class="col-4">
                    <div class="d-flex align-items-center h-100 rounded overflow-hidden"
                        ...
                        <p class="m-0 p-3 h-100 d-flex align-items-center bg-white">
                            Pensando bem, a pergunta é outra: se você pode mudar o destino de um animal de rua, por que
                            não faria isso?
                        </p>
                    </div>
                </div>
